...
var author$project$Main$Model = F4(
	function (fanName, subject, text, submitted) {
		return {H: fanName, N: subject, O: submitted, P: text};
	});
var elm$core$Basics$False = 1;
var author$project$Main$init = A4(author$project$Main$Model, '', '', '', false);
...
var author$project$Main$FanName = function (a) {
	return {$: 0, a: a};
};
var author$project$Main$SandbergSummonClicked = {$: 3};
var author$project$Main$Subject = function (a) {
	return {$: 1, a: a};
};
...
var author$project$Main$view = function (model) {
	return model.O ? A2(
		...
		_List_fromArray(
			[
				elm$html$Html$text('ANDREAS VAR HER')
			])) : A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				A4(author$project$Main$viewInput, 'text', 'FanName', model.H, author$project$Main$FanName),
				A4(author$project$Main$viewInput, 'text', 'Subject', model.N, author$project$Main$Subject),
				A4(author$project$Main$viewInput, 'text', 'Text', model.P, author$project$Main$Text),
				A2(
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$placeholder('Kjære Sandberg..')
					]),
				_List_Nil),
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Main$SandbergSummonClicked)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('Summon Sandberg')
					]))
			]));
};
